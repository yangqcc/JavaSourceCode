...
public interface CallableStatement extends PreparedStatement {
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     * @since 1.4
     */
    java.sql.Date getDate(String parameterName) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    java.sql.Time getTime(String parameterName) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    java.sql.Timestamp getTimestamp(String parameterName) throws java.sql.SQLException;
   ...
   *  <code>Writer</code> or <code>OutputStream</code> has not been closed for the <code>SQLXML</code> object
     ...
     * @since 1.6
     */
    Reader getNCharacterStream(int parameterIndex) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    Reader getNCharacterStream(String parameterName) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    Reader getCharacterStream(int parameterIndex) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    Reader getCharacterStream(String parameterName) throws java.sql.SQLException;
    ...
    */
     ...
     */
    void setCharacterStream(String parameterName,
                            Reader reader) throws java.sql.SQLException;
  /**
     * Sets the designated parameter to a <code>Reader</code> object. The
     * <code>Reader</code> reads the data till end-of-file is reached. The
     * driver does the necessary conversion from Java character format to
