...
public class DriverManager {
     ...
     */
    @CallerSensitive
    public static java.sql.Driver getDriver(String url)
        throws java.sql.SQLException {
        ...
        throw new java.sql.SQLException("No suitable driver", "08001");
    }
    ...
    public static java.util.Enumeration<java.sql.Driver> getDrivers() {
        java.util.Vector<java.sql.Driver> result = new java.util.Vector<>();
    ...
    private static boolean isDriverAllowed(java.sql.Driver driver, Class<?> caller) {
        ClassLoader callerCL = caller != null ? caller.getClassLoader() : null;
        return isDriverAllowed(driver, callerCL);
    }

    private static boolean isDriverAllowed(java.sql.Driver driver, ClassLoader classLoader) {
    ...
    private static java.sql.Connection getConnection(
        String url, java.util.Properties info, Class<?> caller) throws java.sql.SQLException {
        /*
        ...
        if(url == null) {
            throw new java.sql.SQLException("The url cannot be null", "08001");
        }
        ...
        java.sql.SQLException reason = null;
...
class DriverInfo {
    ...
    java.sql.DriverAction da;
    DriverInfo(Driver driver, java.sql.DriverAction action) {
        this.driver = driver;
        da = action;
    }
