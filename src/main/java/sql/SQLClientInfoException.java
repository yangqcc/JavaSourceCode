...
/**
 * The subclass of {@link java.sql.SQLException} is thrown when one or more client info properties
...
public class SQLClientInfoException extends SQLException {
        ...
        private Map<String, java.sql.ClientInfoStatus>   failedProperties;
     ...
     * @since 1.6
     */
        public SQLClientInfoException(Map<String, java.sql.ClientInfoStatus> failedProperties) {
     ...
     */
        public SQLClientInfoException(String reason,
                Map<String, java.sql.ClientInfoStatus> failedProperties) {
