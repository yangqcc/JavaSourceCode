...
class Properties extends java.util.Hashtable<Object,Object> {
    ...
    {
        XmlSupport.load(this, java.util.Objects.requireNonNull(in));
        in.close();
    }
    ...
    public void storeToXML(OutputStream os, String comment, String encoding)
        throws IOException
    {
        XmlSupport.save(this, java.util.Objects.requireNonNull(os), comment,
     ...
     */
    private synchronized void enumerate(java.util.Hashtable<String,Object> h) {
        if (defaults != null) {
