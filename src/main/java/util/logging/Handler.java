...
public abstract class Handler {
    ...
    private volatile java.util.logging.Level logLevel = java.util.logging.Level.ALL;
     ...
     *             the caller does not have <tt>LoggingPermission("control")</tt>.
     */
    public synchronized void setFilter(java.util.logging.Filter newFilter) throws SecurityException {
        checkPermission();
        filter = newFilter;
    }
