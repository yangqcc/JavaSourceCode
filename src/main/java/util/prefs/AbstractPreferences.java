...
public abstract class AbstractPreferences extends java.util.prefs.Preferences {
     ...
     */
    private java.util.prefs.NodeChangeListener[] nodeListeners = new java.util.prefs.NodeChangeListener[0];
     ...
     * {@link java.util.prefs.Preferences#put(String,String)}.
     *
     ...
     * {@link java.util.prefs.Preferences#get(String,String)}.
     *
     ...
     * in {@link java.util.prefs.Preferences#remove(String)}.
     *
     ...
     * {@link java.util.prefs.Preferences#clear()}.
     *
     * <p>This implementation obtains this preference node's lock,
     ...
     * {@link java.util.prefs.Preferences#putInt(String,int)}.
     *
     ...
     * {@link java.util.prefs.Preferences#getInt(String,int)}.
     *
     ...
     * {@link java.util.prefs.Preferences#putLong(String,long)}.
     *
     * <p>This implementation translates <tt>value</tt> to a string with
     ...
     * {@link java.util.prefs.Preferences#getLong(String,long)}.
     *
     * <p>This implementation invokes {@link #get(String,String) <tt>get(key,
     * null)</tt>}.  If the return value is non-null, the implementation
     ...
     * {@link java.util.prefs.Preferences#putBoolean(String,boolean)}.
     *
     * <p>This implementation translates <tt>value</tt> to a string with
     ...
     * {@link java.util.prefs.Preferences#getBoolean(String,boolean)}.
     *
     * <p>This implementation invokes {@link #get(String,String) <tt>get(key,
     ...
     * {@link java.util.prefs.Preferences#putFloat(String,float)}.
     *
     * <p>This implementation translates <tt>value</tt> to a string with
     ...
     * {@link java.util.prefs.Preferences#getFloat(String,float)}.
     *
     * <p>This implementation invokes {@link #get(String,String) <tt>get(key,
     * null)</tt>}.  If the return value is non-null, the implementation
     ...
     * {@link java.util.prefs.Preferences#putDouble(String,double)}.
     *
     * <p>This implementation translates <tt>value</tt> to a string with
     ...
     * {@link java.util.prefs.Preferences#getDouble(String,double)}.
     *
     * <p>This implementation invokes {@link #get(String,String) <tt>get(key,
     * null)</tt>}.  If the return value is non-null, the implementation
     ...
     * {@link java.util.prefs.Preferences#putByteArray(String,byte[])}.
     *
     * @param key key with which the string form of value is to be associated.
     * @param value value whose string form is to be associated with key.
     * @throws NullPointerException if key or value is <tt>null</tt>.
     ...
     * {@link java.util.prefs.Preferences#getByteArray(String,byte[])}.
     *
     ...
     * {@link java.util.prefs.Preferences#keys()}.
     *
     ...
     * {@link java.util.prefs.Preferences#childrenNames()}.
     *
     * <p>This implementation obtains this preference node's lock, checks that
     ...
     * {@link java.util.prefs.Preferences#parent()}.
     *
     * <p>This implementation obtains this preference node's lock, checks that
     ...
     * {@link java.util.prefs.Preferences#node(String)}.
     *
     ...
     *         removed with the {@link #removeNode()} method.
     */
    public java.util.prefs.Preferences node(String path) {
        synchronized(lock) {
            if (removed)
                throw new IllegalStateException("Node has been removed.");
            if (path.equals(""))
     ...
     */
    private java.util.prefs.Preferences node(StringTokenizer path) {
     ...
     * {@link java.util.prefs.Preferences#nodeExists(String)}.
     *
     ...
     * {@link java.util.prefs.Preferences#removeNode()}.
     *
     ...
     * {@link java.util.prefs.Preferences#name()}.
     *
     ...
     * {@link java.util.prefs.Preferences#absolutePath()}.
     *
     ...
     * {@link java.util.prefs.Preferences#isUserNode()}.
     *
    ...
    public boolean isUserNode() {
        return AccessController.doPrivileged(
            new PrivilegedAction<Boolean>() {
                public Boolean run() {
                    return root == java.util.prefs.Preferences.userRoot();
            }
            }).booleanValue();
    }
    ...
    public void addNodeChangeListener(java.util.prefs.NodeChangeListener ncl) {
        ...
        synchronized(lock) {
            ...
            if (nodeListeners == null) {
                nodeListeners = new java.util.prefs.NodeChangeListener[1];
                nodeListeners[0] = ncl;
            } else {
                java.util.prefs.NodeChangeListener[] old = nodeListeners;
                nodeListeners = new java.util.prefs.NodeChangeListener[old.length + 1];
    ...
    public void removeNodeChangeListener(java.util.prefs.NodeChangeListener ncl) {
        synchronized(lock) {
            ...
            if (i == nodeListeners.length)
                throw new IllegalArgumentException("Listener not registered.");
            java.util.prefs.NodeChangeListener[] newNl =
                new java.util.prefs.NodeChangeListener[nodeListeners.length - 1];
            if (i != 0)
    ...
    private class NodeAddedEvent extends java.util.prefs.NodeChangeEvent {
        ...
        NodeAddedEvent(java.util.prefs.Preferences parent, java.util.prefs.Preferences child) {
            super(parent, child);
        }
    }
    private class NodeRemovedEvent extends java.util.prefs.NodeChangeEvent {
        private static final long serialVersionUID = 8735497392918824837L;
        NodeRemovedEvent(java.util.prefs.Preferences parent, java.util.prefs.Preferences child) {
            super(parent, child);
        }
    }
        ...
        public void run() {
            while(true) {
                ...
                if (event instanceof PreferenceChangeEvent) {
                    ...
                    java.util.prefs.NodeChangeEvent nce = (NodeChangeEvent)event;
                    java.util.prefs.NodeChangeListener[] listeners = src.nodeListeners();
     ...
     * this.lock held.
     */
    private void enqueueNodeAddedEvent(java.util.prefs.Preferences child) {
     ...
     * this.lock held.
     */
    private void enqueueNodeRemovedEvent(java.util.prefs.Preferences child) {
        if (nodeListeners.length != 0) {
            synchronized(eventQueue) {
     ...
     * {@link java.util.prefs.Preferences#exportNode(OutputStream)}.
     *
    ...
    {
        java.util.prefs.XmlSupport.export(os, this, false);
    }
    ...
    public void exportSubtree(OutputStream os)
        throws IOException, BackingStoreException
    {
        java.util.prefs.XmlSupport.export(os, this, true);
    }
}
