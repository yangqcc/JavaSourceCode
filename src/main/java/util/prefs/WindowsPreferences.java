...
class WindowsPreferences extends AbstractPreferences {
     ...
     * User root node.
     */
    static final java.util.prefs.Preferences userRoot =
         new WindowsPreferences(USER_ROOT_NATIVE_HANDLE, WINDOWS_ROOT_PATH);

    /**
     * System root node.
     */
    static final java.util.prefs.Preferences systemRoot =
    ...
    */
    ...
    private static String toJavaAlt64Name(String windowsName) {
        byte[] byteBuffer =
                java.util.prefs.Base64.altBase64ToByteArray(windowsName.substring(2));
    ...
    private static byte[] toWindowsAlt64Name(String javaName) {
        ...
        return stringToByteArray("/!" +
                java.util.prefs.Base64.byteArrayToAltBase64(javaNameArray));
    }
