...
abstract class AbstractPipeline<E_IN, E_OUT, S extends java.util.stream.BaseStream<E_OUT, S>>
    ...
    @Override
    @SuppressWarnings("unchecked")
    final <P_IN> void copyIntoWithCancel(java.util.stream.Sink<P_IN> wrappedSink, Spliterator<P_IN> spliterator) {
     ...
     */
    abstract void forEachWithCancel(Spliterator<E_OUT> spliterator, java.util.stream.Sink<E_OUT> sink);
