...
final class Nodes {
    ...
    private static abstract class EmptyNode<T, T_ARR, T_CONS> implements java.util.stream.Node<T> {
        EmptyNode() { }
     ...
     */
    private static abstract class AbstractConcNode<T, T_NODE extends java.util.stream.Node<T>> implements java.util.stream.Node<T> {
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends java.util.stream.Sink<P_OUT>,
    ...
    @SuppressWarnings("serial")
    private static abstract class ToArrayTask<T, T_NODE extends java.util.stream.Node<T>,
